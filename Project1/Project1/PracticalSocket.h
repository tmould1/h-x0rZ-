...
/*
 *  H@x0rZ! Changes:
 *    - Socket::getSockDesc(), returns (int) associated with socket descriptor
 */
...
public:
	...
	*/
	...
	int getSockDesc() throw(SocketException);
...
protected:
	...
	// Begin Section where I need File Descriptor Numbers - Todd
private:
